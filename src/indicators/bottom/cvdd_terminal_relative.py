...
class CVDDTerminalRelativeIndicator(BaseIndicator):
    ...
    def calculate_raw_value(self) -> Optional[float]:
        ...
        For bottom indicator: lower relative position = stronger bottom signal
        """
        try:
            ...
            # For bottom indicator, invert so lower relative position = higher score
            # But we'll handle this in normalization bounds instead
